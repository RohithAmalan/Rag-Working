...
class TestEvaluationRoutes:
    ...
    def test_evaluate_query_success(self, client, mock_evaluator):
        ...
        mock_evaluator.evaluate_single_query = AsyncMock(return_value={
            "answer_relevancy": 0.85,
            "faithfulness": 0.90,
        })

        response = client.post("/evaluation/evaluate-query", json={
    ...
    def test_evaluate_batch_success(self, client, mock_evaluator):
        ...
        response = client.post("/evaluation/evaluate-batch", json={
            "test_cases": [
                {
                    "question": "Q1",
                    "answer": "A1",
