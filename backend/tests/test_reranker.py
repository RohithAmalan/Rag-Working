...
class TestRerankerService:
    ...
    def test_rerank_chunks(self):
        ...
        assert reranked[0]['text'] in ["Python is a programming language", "Machine learning uses Python"]
    ...
    def test_rerank_with_threshold(self):
        ...
        reranked = reranker.rerank_with_threshold(query, chunks, threshold=0.5, top_k=10)
